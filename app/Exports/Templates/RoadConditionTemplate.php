...
class RoadConditionTemplate implements FromArray, WithHeadings, WithStyles, WithColumnWidths
{
    ...
    public function headings(): array
    {
        return [
            ...
            'Pothole_Count',
            'Rutting_Depth',
            'Shoulder_L (kode shoulder condition)',
            'Shoulder_R (kode shoulder condition)',
            'Drain_L (kode drain condition)',
            'Drain_R (kode drain condition)',
            'Slope_L (kode slope condition)',
            'Slope_R (kode slope condition)',
            'Footpath_L (kode foothpath condition)',
            'Footpath_R (kode foothpath condition)',
            'Sign_L',
            'Sign_R',
            'Guide_Post_L',
            'Guide_Post_R',
